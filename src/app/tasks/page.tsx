...
const RedirectPage = () => {
  ...
  const list = useSelector((state: RootState) => state.patientlist.filter(i => i.isSubmitted == true));
    ...
    setPatients(
      list
        .map((i) => ({
          ...
          name: i.profile.name,
          age: i.profile.age,
          currentProcess: i.agentDetails?.currentProcess || "",
          agentAction: i.agentDetails?.agentAction || "",
      ...
      >
        <div className="border-b  border-patient">
          <div className="max-w-345 xl:mx-auto flex gap-3 items-center py-6">
            ...
            <h1 className="font-semibold text-xl">Patient Task Log</h1>
          </div>
        </div>
        ...
        ${patient.selected ? "checkbox" : "bg-white border-gray-400"}`}
                      ...
                      <td className="px-4 py-3 text-sm  max-w-sm">
                        ...
                        <span
                            ...
                            className={`border text-center bg-white rounded-2xl py-1 px-3 ${patient.currentProcess && patient.currentProcess.toLowerCase()}-border`}
                          >
                             {patient.currentProcess}
                          </span>
                      </td>
                      ...
                      <td className="px-4 py-3 whitespace-nowrap text-sm ">
                        <div className="flex justify-between items-center w-15">
                          <Link href={`/patient/${patient.id}`}>
                           ...
                           <Link href={`/patient/${patient.id}/logs`}>
