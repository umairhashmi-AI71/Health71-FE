...
export const fakePersona: PatientPersona[] = [
  ...
  },
  {
    ...
    information: {
      infoCode: "notcovered",
      infoMessage:
        "Prior authorization returned as non-covered benefit, no appeal possible offer patient  OOP payment:",
  ...
  paymentmethod: 'Visa',
    ...
    information: {
      infoCode: "test",
      infoMessage:
        "Coverage expired at date of service — flagged as ineligible, patient notified, prompted to update plan or self-pay.",
